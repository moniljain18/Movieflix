...
const Header = () => {
    ...
    return (
        <div className='absolute z-10 flex w-full items-center justify-between px-6 bg-gradient-to-b from-black opacity-100'>
            <img className='w-56 mb-15 px-5 bg-blend-multiply ' src={logo} alt="netflix-logo" />
            {
                user && (
